...
# Jasper: Resize image if it contains too many boxes
_C.INPUT.MANY_BOXES_LIMIT = 800  # number of boxes for which to perform emergency image resizing
_C.INPUT.MANY_BOXES_SIZE = 800  # size to resize it to
...
# Set input channels to be 3 (RGB)
_C.MODEL.RESNETS.IN_CHANNELS = 3
